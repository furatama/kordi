...
@section('content')
		<div class="my-3 clearfix">
            ...
            <a class="btn btn-lg btn-primary float-right ml-2" href="{!! route('master.partai.report',['by'=>$by,'id'=>$id]) !!}">Report</a>
            ...
            { 
            	...
            	render: function(data, type, row, meta) {
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <a class="dropdown-item" href="{{route('koorl2.index')}}/master.partai/${row.id}">List Asisten</a>
                        @endif
                        @if (Auth::user()->hasAccess('PMR'))
                        <a class="dropdown-item" href="{{route('pemilih.index')}}/master.partai/${row.id}">List Pemilih</a>
                        @endif
